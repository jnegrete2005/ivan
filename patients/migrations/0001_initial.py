# Generated by Django 3.1.4 on 2020-12-26 22:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patho_histo', models.CharField(blank=True, max_length=300, null=True)),
                ('fam_histo', models.CharField(blank=True, max_length=300, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Visit',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default=datetime.datetime(2020, 12, 26, 17, 1, 27, 551426))),
